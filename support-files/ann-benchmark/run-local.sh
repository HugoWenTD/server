...
#
# Usage:
#   [MARIADB_ROOT_DIR=./builddir] [ANN_WORKSPACE=./ann-workspace] [DATASET=random-xs-20-euclidean] ./support-files/ann-benchmark/run-local.sh
#
...
python3 -u run.py  --algorithm mariadb --dataset $DATASET --local --runs 1
